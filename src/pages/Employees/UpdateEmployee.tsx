...
import { ApiGetOneEmployee, ApiUpdateEmployee } from '../../lib/services/Employee';
...
const UpdateEmployee = () => {
    ...
    useEffect(() => {
        const fetchEmployee = async () => {
            try {
                const res = await ApiGetOneEmployee(id);
                if (res) {
                    setEmployee(res.data);
                    setLoading(false);
                } else {
                    sendToastError('Employee not found.');
                    navigate('/employees');
                }
            } catch (error) {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            ...
            sendToast('Employee updated successfully.');
            navigate('/employees');
        } catch (error) {
    ...
    return (
        <div className="bg-gray-100 min-h-screen flex justify-center items-center">
            <div className="bg-white rounded-lg shadow-md p-8">
                <h2 className="text-2xl mb-6 font-semibold text-center">Update Employee</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="payRate" name="payRate" placeholder="Enter pay rate"
                        ...
                        <div>
                            ...
                            <input type="text" id="payRateId" name="payRateId" placeholder="Enter pay rate id"
